...
const (
	PushMsgService_PushMsg_FullMethodName          = "/push.PushMsgService/PushMsg"
	PushMsgService_SetUserPushToken_FullMethodName = "/push.PushMsgService/SetUserPushToken"
	PushMsgService_DelUserPushToken_FullMethodName = "/push.PushMsgService/DelUserPushToken"
)
...
type PushMsgServiceClient interface {
	...
	SetUserPushToken(ctx context.Context, in *SetUserPushTokenReq, opts ...grpc.CallOption) (*SetUserPushTokenResp, error)
...
func (c *pushMsgServiceClient) SetUserPushToken(ctx context.Context, in *SetUserPushTokenReq, opts ...grpc.CallOption) (*SetUserPushTokenResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SetUserPushTokenResp)
	err := c.cc.Invoke(ctx, PushMsgService_SetUserPushToken_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type PushMsgServiceServer interface {
	...
	SetUserPushToken(context.Context, *SetUserPushTokenReq) (*SetUserPushTokenResp, error)
...
func (UnimplementedPushMsgServiceServer) SetUserPushToken(context.Context, *SetUserPushTokenReq) (*SetUserPushTokenResp, error) {
	return nil, status.Error(codes.Unimplemented, "method SetUserPushToken not implemented")
}
...
func _PushMsgService_SetUserPushToken_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SetUserPushTokenReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PushMsgServiceServer).SetUserPushToken(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: PushMsgService_SetUserPushToken_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PushMsgServiceServer).SetUserPushToken(ctx, req.(*SetUserPushTokenReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var PushMsgService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "SetUserPushToken",
			Handler:    _PushMsgService_SetUserPushToken_Handler,
		},
		{
