...
type Conversation struct {
	...
	MsgInfo       *MsgInfo `protobuf:"bytes,19,opt,name=msg_info,json=msgInfo,proto3" json:"msg_info,omitempty"`
...
func (x *Conversation) GetMsgInfo() *MsgInfo {
	if x != nil {
		return x.MsgInfo
	}
	return nil
...
type MsgInfo struct {
	...
	GroupFaceUrl      string                 `protobuf:"bytes,10,opt,name=group_face_url,json=groupFaceUrl,proto3" json:"group_face_url,omitempty"`
	GroupType         int32                  `protobuf:"varint,11,opt,name=group_type,json=groupType,proto3" json:"group_type,omitempty"`
	GroupMemberCount  uint32                 `protobuf:"varint,12,opt,name=group_member_count,json=groupMemberCount,proto3" json:"group_member_count,omitempty"`
	LatestMsgRecvTime int64                  `protobuf:"varint,13,opt,name=latest_msg_recv_time,json=latestMsgRecvTime,proto3" json:"latest_msg_recv_time,omitempty"`
	MsgFrom           int32                  `protobuf:"varint,14,opt,name=msg_from,json=msgFrom,proto3" json:"msg_from,omitempty"`
	ContentType       int32                  `protobuf:"varint,15,opt,name=content_type,json=contentType,proto3" json:"content_type,omitempty"`
...
type ConversationElem struct {
	...
	MsgInfo        *MsgInfo               `protobuf:"bytes,5,opt,name=msg_info,json=msgInfo,proto3" json:"msg_info,omitempty"`
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
type GetSortedConversationListResp struct {
	state             protoimpl.MessageState `protogen:"open.v1"`
	Total             int64                  `protobuf:"varint,1,opt,name=total,proto3" json:"total,omitempty"` // 同 OpenIM conversationTotal
...
type SetConversationsReq struct {
	...
	Conversation  *ConversationReq       `protobuf:"bytes,2,opt,name=conversation,proto3" json:"conversation,omitempty"` // 对齐 OpenIM：部分字段更新
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type DeleteConversationsReq struct {
	...
	OwnerUserId     string                 `protobuf:"bytes,1,opt,name=owner_user_id,json=ownerUserId,proto3" json:"owner_user_id,omitempty"`
	ConversationIds []string               `protobuf:"bytes,2,rep,name=conversation_ids,json=conversationIds,proto3" json:"conversation_ids,omitempty"`
	NeedDeleteTime  int64                  `protobuf:"varint,3,opt,name=need_delete_time,json=needDeleteTime,proto3" json:"need_delete_time,omitempty"` // 对齐 OpenIM：可选，>0 时仅删 create_time 早于该时刻的会话
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
const file_conversation_proto_rawDesc = "" +
	"\n" +
	"\x12conversation.proto\x12\fconversation\"\xb3\x05\n" +
	"\fConversation\x12\"\n" +
	...
	"createTime\x120\n" +
	"\bmsg_info\x18\x13 \x01(\v2\x15.conversation.MsgInfoR\amsgInfo\"\xca\x06\n" +
	...
	"\x19_latest_msg_destruct_time\"\xa8\x04\n" +
	"\aMsgInfo\x12\"\n" +
	"\rserver_msg_id\x18\x01 \x01(\tR\vserverMsgId\x12\"\n" +
	"\rclient_msg_id\x18\x02 \x01(\tR\vclientMsgId\x12!\n" +
	"\fsession_type\x18\x03 \x01(\x05R\vsessionType\x12\x17\n" +
	"\asend_id\x18\x04 \x01(\tR\x06sendId\x12\x17\n" +
	"\arecv_id\x18\x05 \x01(\tR\x06recvId\x12\x1f\n" +
	"\vsender_name\x18\x06 \x01(\tR\n" +
	"senderName\x12\x19\n" +
	"\bface_url\x18\a \x01(\tR\afaceUrl\x12\x19\n" +
	"\bgroup_id\x18\b \x01(\tR\agroupId\x12\x1d\n" +
	"\n" +
	"group_name\x18\t \x01(\tR\tgroupName\x12$\n" +
	"\x0egroup_face_url\x18\n" +
	" \x01(\tR\fgroupFaceUrl\x12\x1d\n" +
	"\n" +
	"group_type\x18\v \x01(\x05R\tgroupType\x12,\n" +
	"\x12group_member_count\x18\f \x01(\rR\x10groupMemberCount\x12/\n" +
	"\x14latest_msg_recv_time\x18\r \x01(\x03R\x11latestMsgRecvTime\x12\x19\n" +
	"\bmsg_from\x18\x0e \x01(\x05R\amsgFrom\x12!\n" +
	"\fcontent_type\x18\x0f \x01(\x05R\vcontentType\x12\x18\n" +
	"\acontent\x18\x10 \x01(\tR\acontent\x12\x0e\n" +
	"\x02ex\x18\x11 \x01(\tR\x02ex\"\xcf\x01\n" +
	"\x10ConversationElem\x12'\n" +
	"\x0fconversation_id\x18\x01 \x01(\tR\x0econversationId\x12 \n" +
	"\frecv_msg_opt\x18\x02 \x01(\x05R\n" +
	"recvMsgOpt\x12!\n" +
	"\funread_count\x18\x03 \x01(\x03R\vunreadCount\x12\x1b\n" +
	"\tis_pinned\x18\x04 \x01(\bR\bisPinned\x120\n" +
	"\bmsg_info\x18\x05 \x01(\v2\x15.conversation.MsgInfoR\amsgInfo\"T\n" +
	...
	"\x10conversation_ids\x18\x01 \x03(\tR\x0fconversationIds\"s\n" +
	"\x13SetConversationsReq\x12\x19\n" +
	"\buser_ids\x18\x01 \x03(\tR\auserIds\x12A\n" +
	"\fconversation\x18\x02 \x01(\v2\x1d.conversation.ConversationReqR\fconversation\"\x16\n" +
	...
	"\x10conversation_ids\x18\x01 \x03(\tR\x0fconversationIds\"\x91\x01\n" +
	"\x16DeleteConversationsReq\x12\"\n" +
	"\rowner_user_id\x18\x01 \x01(\tR\vownerUserId\x12)\n" +
	"\x10conversation_ids\x18\x02 \x03(\tR\x0fconversationIds\x12(\n" +
	"\x10need_delete_time\x18\x03 \x01(\x03R\x0eneedDeleteTime\"\x19\n" +
...
var file_conversation_proto_msgTypes = make([]protoimpl.MessageInfo, 56)
var file_conversation_proto_goTypes = []any{
	...
	(*MsgInfo)(nil),                                     // 2: conversation.MsgInfo
	(*ConversationElem)(nil),                            // 3: conversation.ConversationElem
	(*SetConversationReq)(nil),                          // 4: conversation.SetConversationReq
	(*SetConversationResp)(nil),                         // 5: conversation.SetConversationResp
	(*GetConversationReq)(nil),                          // 6: conversation.GetConversationReq
	(*GetConversationResp)(nil),                         // 7: conversation.GetConversationResp
	(*GetConversationsReq)(nil),                         // 8: conversation.GetConversationsReq
	(*GetConversationsResp)(nil),                        // 9: conversation.GetConversationsResp
	(*GetAllConversationsReq)(nil),                      // 10: conversation.GetAllConversationsReq
	(*GetAllConversationsResp)(nil),                     // 11: conversation.GetAllConversationsResp
	(*GetSortedConversationListReq)(nil),                // 12: conversation.GetSortedConversationListReq
	(*GetSortedConversationListResp)(nil),               // 13: conversation.GetSortedConversationListResp
	(*CreateSingleChatConversationsReq)(nil),            // 14: conversation.CreateSingleChatConversationsReq
	(*CreateSingleChatConversationsResp)(nil),           // 15: conversation.CreateSingleChatConversationsResp
	(*CreateGroupChatConversationsReq)(nil),             // 16: conversation.CreateGroupChatConversationsReq
	(*CreateGroupChatConversationsResp)(nil),            // 17: conversation.CreateGroupChatConversationsResp
	(*SetConversationMaxSeqReq)(nil),                    // 18: conversation.SetConversationMaxSeqReq
	(*SetConversationMaxSeqResp)(nil),                   // 19: conversation.SetConversationMaxSeqResp
	(*SetConversationMinSeqReq)(nil),                    // 20: conversation.SetConversationMinSeqReq
	(*SetConversationMinSeqResp)(nil),                   // 21: conversation.SetConversationMinSeqResp
	(*GetConversationIDsReq)(nil),                       // 22: conversation.GetConversationIDsReq
	(*GetConversationIDsResp)(nil),                      // 23: conversation.GetConversationIDsResp
	(*SetConversationsReq)(nil),                         // 24: conversation.SetConversationsReq
	(*SetConversationsResp)(nil),                        // 25: conversation.SetConversationsResp
	(*UpdateConversationReq)(nil),                       // 26: conversation.UpdateConversationReq
	(*UpdateConversationResp)(nil),                      // 27: conversation.UpdateConversationResp
	(*GetConversationsByConversationIDReq)(nil),         // 28: conversation.GetConversationsByConversationIDReq
	(*GetConversationsByConversationIDResp)(nil),        // 29: conversation.GetConversationsByConversationIDResp
	(*GetRecvMsgNotNotifyUserIDsReq)(nil),               // 30: conversation.GetRecvMsgNotNotifyUserIDsReq
	(*GetRecvMsgNotNotifyUserIDsResp)(nil),              // 31: conversation.GetRecvMsgNotNotifyUserIDsResp
	(*GetConversationOfflinePushUserIDsReq)(nil),        // 32: conversation.GetConversationOfflinePushUserIDsReq
	(*GetConversationOfflinePushUserIDsResp)(nil),       // 33: conversation.GetConversationOfflinePushUserIDsResp
	(*GetConversationNotReceiveMessageUserIDsReq)(nil),  // 34: conversation.GetConversationNotReceiveMessageUserIDsReq
	(*GetConversationNotReceiveMessageUserIDsResp)(nil), // 35: conversation.GetConversationNotReceiveMessageUserIDsResp
	(*GetPinnedConversationIDsReq)(nil),                 // 36: conversation.GetPinnedConversationIDsReq
	(*GetPinnedConversationIDsResp)(nil),                // 37: conversation.GetPinnedConversationIDsResp
	(*GetNotNotifyConversationIDsReq)(nil),              // 38: conversation.GetNotNotifyConversationIDsReq
	(*GetNotNotifyConversationIDsResp)(nil),             // 39: conversation.GetNotNotifyConversationIDsResp
	(*DeleteConversationsReq)(nil),                      // 40: conversation.DeleteConversationsReq
	(*DeleteConversationsResp)(nil),                     // 41: conversation.DeleteConversationsResp
	(*UpdateConversationsByUserReq)(nil),                // 42: conversation.UpdateConversationsByUserReq
	(*UpdateConversationsByUserResp)(nil),               // 43: conversation.UpdateConversationsByUserResp
	(*GetUserConversationIDsHashReq)(nil),               // 44: conversation.GetUserConversationIDsHashReq
	(*GetUserConversationIDsHashResp)(nil),              // 45: conversation.GetUserConversationIDsHashResp
	(*GetOwnerConversationReq)(nil),                     // 46: conversation.GetOwnerConversationReq
	(*GetOwnerConversationResp)(nil),                    // 47: conversation.GetOwnerConversationResp
	(*ClearUserConversationMsgReq)(nil),                 // 48: conversation.ClearUserConversationMsgReq
	(*ClearUserConversationMsgResp)(nil),                // 49: conversation.ClearUserConversationMsgResp
	(*GetConversationsNeedClearMsgReq)(nil),             // 50: conversation.GetConversationsNeedClearMsgReq
	(*GetConversationsNeedClearMsgResp)(nil),            // 51: conversation.GetConversationsNeedClearMsgResp
	(*GetFullOwnerConversationIDsReq)(nil),              // 52: conversation.GetFullOwnerConversationIDsReq
	(*GetFullOwnerConversationIDsResp)(nil),             // 53: conversation.GetFullOwnerConversationIDsResp
	(*GetIncrementalConversationReq)(nil),               // 54: conversation.GetIncrementalConversationReq
	(*GetIncrementalConversationResp)(nil),              // 55: conversation.GetIncrementalConversationResp
}
var file_conversation_proto_depIdxs = []int32{
	2,  // 0: conversation.Conversation.msg_info:type_name -> conversation.MsgInfo
	2,  // 1: conversation.ConversationElem.msg_info:type_name -> conversation.MsgInfo
	0,  // 2: conversation.SetConversationReq.conversation:type_name -> conversation.Conversation
	0,  // 3: conversation.GetConversationResp.conversation:type_name -> conversation.Conversation
	0,  // 4: conversation.GetConversationsResp.conversations:type_name -> conversation.Conversation
	0,  // 5: conversation.GetAllConversationsResp.conversations:type_name -> conversation.Conversation
	3,  // 6: conversation.GetSortedConversationListResp.conversation_elems:type_name -> conversation.ConversationElem
	1,  // 7: conversation.SetConversationsReq.conversation:type_name -> conversation.ConversationReq
	1,  // 8: conversation.UpdateConversationReq.conversation:type_name -> conversation.ConversationReq
	0,  // 9: conversation.GetConversationsByConversationIDResp.conversations:type_name -> conversation.Conversation
	0,  // 10: conversation.GetOwnerConversationResp.conversations:type_name -> conversation.Conversation
	0,  // 11: conversation.GetConversationsNeedClearMsgResp.conversations:type_name -> conversation.Conversation
	0,  // 12: conversation.GetIncrementalConversationResp.conversations:type_name -> conversation.Conversation
	4,  // 13: conversation.conversation.SetConversation:input_type -> conversation.SetConversationReq
	6,  // 14: conversation.conversation.GetConversation:input_type -> conversation.GetConversationReq
	8,  // 15: conversation.conversation.GetConversations:input_type -> conversation.GetConversationsReq
	10, // 16: conversation.conversation.GetAllConversations:input_type -> conversation.GetAllConversationsReq
	12, // 17: conversation.conversation.GetSortedConversationList:input_type -> conversation.GetSortedConversationListReq
	14, // 18: conversation.conversation.CreateSingleChatConversations:input_type -> conversation.CreateSingleChatConversationsReq
	16, // 19: conversation.conversation.CreateGroupChatConversations:input_type -> conversation.CreateGroupChatConversationsReq
	18, // 20: conversation.conversation.SetConversationMaxSeq:input_type -> conversation.SetConversationMaxSeqReq
	20, // 21: conversation.conversation.SetConversationMinSeq:input_type -> conversation.SetConversationMinSeqReq
	22, // 22: conversation.conversation.GetConversationIDs:input_type -> conversation.GetConversationIDsReq
	24, // 23: conversation.conversation.SetConversations:input_type -> conversation.SetConversationsReq
	26, // 24: conversation.conversation.UpdateConversation:input_type -> conversation.UpdateConversationReq
	28, // 25: conversation.conversation.GetConversationsByConversationID:input_type -> conversation.GetConversationsByConversationIDReq
	30, // 26: conversation.conversation.GetRecvMsgNotNotifyUserIDs:input_type -> conversation.GetRecvMsgNotNotifyUserIDsReq
	32, // 27: conversation.conversation.GetConversationOfflinePushUserIDs:input_type -> conversation.GetConversationOfflinePushUserIDsReq
	34, // 28: conversation.conversation.GetConversationNotReceiveMessageUserIDs:input_type -> conversation.GetConversationNotReceiveMessageUserIDsReq
	36, // 29: conversation.conversation.GetPinnedConversationIDs:input_type -> conversation.GetPinnedConversationIDsReq
	38, // 30: conversation.conversation.GetNotNotifyConversationIDs:input_type -> conversation.GetNotNotifyConversationIDsReq
	40, // 31: conversation.conversation.DeleteConversations:input_type -> conversation.DeleteConversationsReq
	42, // 32: conversation.conversation.UpdateConversationsByUser:input_type -> conversation.UpdateConversationsByUserReq
	44, // 33: conversation.conversation.GetUserConversationIDsHash:input_type -> conversation.GetUserConversationIDsHashReq
	46, // 34: conversation.conversation.GetOwnerConversation:input_type -> conversation.GetOwnerConversationReq
	48, // 35: conversation.conversation.ClearUserConversationMsg:input_type -> conversation.ClearUserConversationMsgReq
	50, // 36: conversation.conversation.GetConversationsNeedClearMsg:input_type -> conversation.GetConversationsNeedClearMsgReq
	52, // 37: conversation.conversation.GetFullOwnerConversationIDs:input_type -> conversation.GetFullOwnerConversationIDsReq
	54, // 38: conversation.conversation.GetIncrementalConversation:input_type -> conversation.GetIncrementalConversationReq
	5,  // 39: conversation.conversation.SetConversation:output_type -> conversation.SetConversationResp
	7,  // 40: conversation.conversation.GetConversation:output_type -> conversation.GetConversationResp
	9,  // 41: conversation.conversation.GetConversations:output_type -> conversation.GetConversationsResp
	11, // 42: conversation.conversation.GetAllConversations:output_type -> conversation.GetAllConversationsResp
	13, // 43: conversation.conversation.GetSortedConversationList:output_type -> conversation.GetSortedConversationListResp
	15, // 44: conversation.conversation.CreateSingleChatConversations:output_type -> conversation.CreateSingleChatConversationsResp
	17, // 45: conversation.conversation.CreateGroupChatConversations:output_type -> conversation.CreateGroupChatConversationsResp
	19, // 46: conversation.conversation.SetConversationMaxSeq:output_type -> conversation.SetConversationMaxSeqResp
	21, // 47: conversation.conversation.SetConversationMinSeq:output_type -> conversation.SetConversationMinSeqResp
	23, // 48: conversation.conversation.GetConversationIDs:output_type -> conversation.GetConversationIDsResp
	25, // 49: conversation.conversation.SetConversations:output_type -> conversation.SetConversationsResp
	27, // 50: conversation.conversation.UpdateConversation:output_type -> conversation.UpdateConversationResp
	29, // 51: conversation.conversation.GetConversationsByConversationID:output_type -> conversation.GetConversationsByConversationIDResp
	31, // 52: conversation.conversation.GetRecvMsgNotNotifyUserIDs:output_type -> conversation.GetRecvMsgNotNotifyUserIDsResp
	33, // 53: conversation.conversation.GetConversationOfflinePushUserIDs:output_type -> conversation.GetConversationOfflinePushUserIDsResp
	35, // 54: conversation.conversation.GetConversationNotReceiveMessageUserIDs:output_type -> conversation.GetConversationNotReceiveMessageUserIDsResp
	37, // 55: conversation.conversation.GetPinnedConversationIDs:output_type -> conversation.GetPinnedConversationIDsResp
	39, // 56: conversation.conversation.GetNotNotifyConversationIDs:output_type -> conversation.GetNotNotifyConversationIDsResp
	41, // 57: conversation.conversation.DeleteConversations:output_type -> conversation.DeleteConversationsResp
	43, // 58: conversation.conversation.UpdateConversationsByUser:output_type -> conversation.UpdateConversationsByUserResp
	45, // 59: conversation.conversation.GetUserConversationIDsHash:output_type -> conversation.GetUserConversationIDsHashResp
	47, // 60: conversation.conversation.GetOwnerConversation:output_type -> conversation.GetOwnerConversationResp
	49, // 61: conversation.conversation.ClearUserConversationMsg:output_type -> conversation.ClearUserConversationMsgResp
	51, // 62: conversation.conversation.GetConversationsNeedClearMsg:output_type -> conversation.GetConversationsNeedClearMsgResp
	53, // 63: conversation.conversation.GetFullOwnerConversationIDs:output_type -> conversation.GetFullOwnerConversationIDsResp
	55, // 64: conversation.conversation.GetIncrementalConversation:output_type -> conversation.GetIncrementalConversationResp
...
func file_conversation_proto_init() {
	...
	file_conversation_proto_msgTypes[1].OneofWrappers = []any{}
	type x struct{}
