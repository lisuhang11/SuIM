...
const (
	Conversation_SetConversation_FullMethodName                         = "/conversation.conversation/SetConversation"
	...
	Conversation_GetAllConversations_FullMethodName                     = "/conversation.conversation/GetAllConversations"
	Conversation_GetSortedConversationList_FullMethodName               = "/conversation.conversation/GetSortedConversationList"
	Conversation_CreateSingleChatConversations_FullMethodName           = "/conversation.conversation/CreateSingleChatConversations"
	Conversation_CreateGroupChatConversations_FullMethodName            = "/conversation.conversation/CreateGroupChatConversations"
	Conversation_SetConversationMaxSeq_FullMethodName                   = "/conversation.conversation/SetConversationMaxSeq"
	Conversation_SetConversationMinSeq_FullMethodName                   = "/conversation.conversation/SetConversationMinSeq"
	Conversation_GetConversationIDs_FullMethodName                      = "/conversation.conversation/GetConversationIDs"
	Conversation_SetConversations_FullMethodName                        = "/conversation.conversation/SetConversations"
	Conversation_UpdateConversation_FullMethodName                      = "/conversation.conversation/UpdateConversation"
	Conversation_GetConversationsByConversationID_FullMethodName        = "/conversation.conversation/GetConversationsByConversationID"
	Conversation_GetRecvMsgNotNotifyUserIDs_FullMethodName              = "/conversation.conversation/GetRecvMsgNotNotifyUserIDs"
	Conversation_GetConversationOfflinePushUserIDs_FullMethodName       = "/conversation.conversation/GetConversationOfflinePushUserIDs"
	Conversation_GetConversationNotReceiveMessageUserIDs_FullMethodName = "/conversation.conversation/GetConversationNotReceiveMessageUserIDs"
	Conversation_GetPinnedConversationIDs_FullMethodName                = "/conversation.conversation/GetPinnedConversationIDs"
	Conversation_GetNotNotifyConversationIDs_FullMethodName             = "/conversation.conversation/GetNotNotifyConversationIDs"
	Conversation_DeleteConversations_FullMethodName                     = "/conversation.conversation/DeleteConversations"
	Conversation_UpdateConversationsByUser_FullMethodName               = "/conversation.conversation/UpdateConversationsByUser"
	Conversation_GetUserConversationIDsHash_FullMethodName              = "/conversation.conversation/GetUserConversationIDsHash"
	Conversation_GetOwnerConversation_FullMethodName                    = "/conversation.conversation/GetOwnerConversation"
	Conversation_ClearUserConversationMsg_FullMethodName                = "/conversation.conversation/ClearUserConversationMsg"
	Conversation_GetConversationsNeedClearMsg_FullMethodName            = "/conversation.conversation/GetConversationsNeedClearMsg"
	Conversation_GetFullOwnerConversationIDs_FullMethodName             = "/conversation.conversation/GetFullOwnerConversationIDs"
	Conversation_GetIncrementalConversation_FullMethodName              = "/conversation.conversation/GetIncrementalConversation"
)
